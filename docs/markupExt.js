...
markup3d.prototype.load = function () {
  ...
  this.update_Line = function () {
    ...
    this.line3d.geometry.vertices[2].set(
      position.x + this.labelOffset.x * Math.sign(position.x),
      position.y + 20 + this.labelOffset.y,
      position.z + this.labelOffset.z
    );
  ...
  this.onClick = function (e) {
    ...
    if (this.isAddMode) {
      ...
      if (posInWorld) {
        ...
        this.setMarkupData([...this.markupItems, mark]);
      }
      ...
      this.viewer.clearSelection(); // not working
    }
  };
  return true;
};
...
markup3d.prototype.onToolbarCreated = function (toolbar) {
  ...
  this.subToolbar.addControl(this.addButton);
